...
urlpatterns = [
    ...
    path('category-reklam/<int:id>/', CategoryReklamAPIView.as_view(), name='category-reklam'),
    ...
    path('store-orders/', StoreOrderAPIView.as_view(), name='store-order'),
