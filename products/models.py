...
class Product(models.Model):
    ...
    short_desc1 = models.CharField(max_length=1000,null=True, blank=True)
    short_desc2 = models.CharField(max_length=1000,null=True, blank=True)
    short_desc3 = models.CharField(max_length=1000,null=True, blank=True)
    ...
    views = models.IntegerField('Views', null=True, blank=True, default=0)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
